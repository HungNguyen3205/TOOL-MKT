...
start "Queue Worker" cmd /c "cd backend && php artisan queue:work database --queue=facebook-publish,image-generation,video-generation,default --tries=3 --timeout=120"
